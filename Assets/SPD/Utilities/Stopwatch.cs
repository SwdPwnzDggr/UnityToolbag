...
namespace SPD.Utilities
{
    public class Stopwatch
    {
        ...
        /// </summary>
        public Stopwatch(bool loop) : this(loop, 0f)
        {
        }
        ...
        public Stopwatch(bool loop, float startDuration)
        {
            Loop = loop;
        ...
        public Stopwatch(bool loop, Func<float> calculateDurationDelegate, float? startDuration = null)
        {
            Loop = loop;
